...
export default function MainSection() {
  ...
  return (
    // ✅ Fullscreen-wide gradient background only for hero section
    <div className="w-full bg-gradient-to-br from-blue-600 to-indigo-600 text-white">
      ...
      {/* Tips card stays inside the blue section */}
      <TipsCard />
    </div>
  )
}