...
const reasons = [
  ...
  },
  {
    ...
    desc: 'Snap a photo of your question or type it out — both work!'
  },
  {
    icon: '🔒',
  ...
  },
  {
    ...
    desc: 'No need to wait for tutors — get help instantly, anytime.'
  }
]
    ...
    <section className="bg-white dark:bg-neutral-900 py-16 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {reasons.map((reason, i) => (
          <div
            key={i}
            className="bg-gray-50 dark:bg-neutral-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-sm text-left hover:shadow-md transition"
          >
